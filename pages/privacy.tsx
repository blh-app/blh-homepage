...
export const Privacy: NextPage = () => {
  return (
    <DefaultLayout>
      ...
      <h2>Google Maps</h2>
      <p>
        Wir setzen auf Technologien des Anbieters Google Maps (Google LLC 1600
        Amphitheatre Parkway Mountain View, CA 94043). Wir setzen die
        Technologie ein um unsere Angebote zu verbessern. Die Rechtsgrundlage
        für diese Verarbeitung bildet Art. 6 Abs. 1 lit. a DSGVO (Einwilligung).
      ...
      <p>
        ...
        Dienstleistungen. Sie haben die Möglichkeit, die Speicherung des Cookies
        auf Ihrem Gerät zu verhindern, indem Sie in Ihrem Browser entsprechende
        ...
        Datenschutzerklärung für die Verwendung von Google AdSense Diese Website
        verwendet Google AdSense. Es handelt sich hierbei um einen Dienst der
        Google Inc., 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA,
        zur Einbindung von Werbeanzeigen. Google AdSense verwendet Cookies. Dies
        sind Dateien, durch deren Speicherung auf Ihrem PC Google die Daten
        Ihrer Benutzung unserer Website analysieren kann. Zudem werden bei
        Google AdSense zusätzlich Web Beacons verwendet, nicht sichtbare
        Grafiken, die es Google ermöglichen, Klicks auf dieser Website, den
        Verkehr auf dieser und ähnliche Informationen zu analysieren. Die über
        ...
        gesammelten Informationen möglicherweise an Dritte weitergeben, wenn
        dies gesetzlich erforderlich ist oder Google gegenüber Dritten die
        Datenverarbeitung in Auftrag gibt. Allerdings wird Google Ihre
        IP-Adresse zusammen mit den anderen gespeicherten Daten zusammenführen.
